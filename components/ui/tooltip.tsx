...
// If you already have cn() in "@/lib/utils", keep this import and delete the inline cn below.
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      // panel
      "z-50 overflow-hidden rounded-lg border border-gray-700 bg-gray-900 px-3 py-2 shadow-md",
      // text
